...
{Minsk}{Bachelor}{I got a 10/10 in the microcontroller course.  I also
prepared reports on CAD programs for the for the university science
conference.  I have learnt how to use EDA CAD programs such as KiCAD
or CAE programs such as COMSOL Multiphysics.  The subject of my
bachelor thesis is a flight controller for the UAV.}

\section{Key skills \& Completed Projects}
\subsection{PCB design with KiCAD}

\cvitem{Flight controller for the UAV}{
  Two layered PCB design I did for my bachelor thesis.
  \url{https://github.com/artsi0m/SST}
}
\cvitem{RS232 to RS485 Converter}{
  Two layered PCB design with structured element list
  done on apprenticeship.
  \url{https://github.com/artsi0m/6sem_practice}}
